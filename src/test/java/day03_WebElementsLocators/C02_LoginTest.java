...
public class C02_LoginTest {
    public static void main(String[] args) throws InterruptedException {
       ...
       // ii. Password : Test1234!
        ...
        WebElement girisYazisiElemeni=driver.findElement(By.tagName("h1"));
        System.out.println(girisYazisiElemeni.getText());
        String actualGirisYazisi=girisYazisiElemeni.getText();
        ...
        WebElement signOutElemen=driver.findElement(By.linkText("Sign out"));
        ...
        List<WebElement> linklerListe=driver.findElements(By.tagName("a"));
        System.out.println("sayfada " + linklerListe.size() + " adet Link bulunmkatadir");
    }
}
