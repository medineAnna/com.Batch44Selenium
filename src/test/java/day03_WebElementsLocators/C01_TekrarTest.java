...
public class C01_TekrarTest {
 ...
 System.setProperty("webdriver.chrome.driver","src/driver/chromedriver");
   ...
   if (actualTitleYoutube.equals(expectedYoutubeTitle)){
       ...
       System.out.println("Youtube Title Testi FAILED" + actualTitleYoutube);
   }
   ...
   if(actualYoutubeUrl.contains(arananKelimeYoutubeUrl)){
       System.out.println("Youtube Url PASS");
   }else{
   ...
   //5. Youtube sayfasina geri donun
        ...
        String actualAmzonTitle= driver.getTitle();
        String amazonTitleArananKelime="Amazon";

        if(actualAmzonTitle.contains(amazonTitleArananKelime)){
            System.out.println("Amazon Title testi PASS");
        }else{
            System.out.println("Amazon Title testi FAILED \nActual Amzon Title: " + actualAmzonTitle);
        }
